    ...
    <>
      <style>{`
        ...
        @media(hover: none) and (pointer: coarse) {
          .nav-link, .nav-hire, .toggle-pill, .ham-btn { cursor: auto !important; }
        }
      `}</style>
      ...
      <nav style={{
        ...
        justifyContent: "space-between", padding: "0 clamp(20px, 4vw, 60px)",
        ...
        {/* Logo */}
        <button onClick={() => { scrollTo("home"); window.dispatchEvent(new CustomEvent("logo:click")); }} style={{
