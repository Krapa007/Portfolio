...
const JSON_LINES = [
  ...
  ["entry", ["award", "🏆 Best Paper — Sentiment AI"]],
  ...
  return (
    ...
    >
      <div style={{
        ...
        {/* ── LEFT ── */}
        <div className="rv" style={{ flex: "1 1 300px", minWidth: 0 }}>
          ...
          <p style={{
            ...
            Currently a{" "}
            <strong style={{ color: "var(--text)", fontWeight: 600 }}> Junior Software Developer at Stackular</strong>.
          </p>
        ...
        <div className="rv" style={{
          flex: "0 0 340px", width: 340, alignSelf: "center", transitionDelay: ".2s",
          display: "var(--json-display, block)",
        }}>
          <style>{`@media(max-width:768px){.json-panel{display:none!important;}}`}</style>
          <div className="json-panel" style={{ ...GLASS_STYLE, overflow: "hidden", position: "relative" }}>
            {/* Shimmer */}
            <div style={{
              position: "absolute", top: 0, left: 0, right: 0, height: 1,
