...
export const SKILLS = [
  {
    name: "React.js",
    cat: "Frontend • UI",
    desc: "Built 2 full production apps — Vibezee and Recipe Hub — using hooks, context, TanStack Query, and component-based architecture. Strong in routing and state management.",
    chips: ["React 18", "Hooks", "Context", "TanStack Query", "React Router"],
    projs: ["Project 1", "Project 2"],
    // signal: accent color for bg canvas when this row is hovered
  ...
  },
  {
    ...
    desc: "Production-grade semantic HTML and responsive CSS across both projects. Tailwind CSS utility-first workflow, animations, accessibility, and cross-browser compatibility.",
    chips: ["TailwindCSS", "Bootstrap", "CSS Grid", "Flexbox", "Animations"],
    projs: ["Project 1", "Project 2"],
  ...
  },
  {
    name: "JavaScript",
    cat: "Programming",
    desc: "ES6+ across the full stack — async/await, promises, closures, destructuring. Udemy certified. All business logic and API integration written in vanilla JS / Node.",
    chips: ["ES6+", "Async/Await", "Promises", "DOM APIs"],
    projs: ["Project 1", "Project 2"],
